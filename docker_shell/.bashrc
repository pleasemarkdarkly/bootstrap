...
if [ -f $HOME/docker_shell/git-prompt.sh ]; then
  source $HOME/docker_shell/git-prompt.sh
...
# Git
source $HOME/docker_shell/git-completion.sh

# Z
source $HOME/docker_shell/z.sh
